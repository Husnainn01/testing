        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div class="float-right d-inline">
                    <a href="{{ route('admin_shipping_documents.create', $shippment->id) }}" class="btn btn-primary btn-sm"><i
                            class="fa fa-plus"></i> Attach Documents</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @forelse($documents as $document)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin_shipping_documents.destroy', $document->id) }}"
