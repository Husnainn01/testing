        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="listing_location_name" class="form-control" value="{{ $listing_location->listing_location_name }}" autofocus required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" value="{{ $listing_location->email }}" required>
                </div>
                <div class="form-group">
