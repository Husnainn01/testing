    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @can('admin_setting_general', 'admin_payment', 'admin_currency_view', 'admin_social_media_view')
                <li
                    class="nav-item {{ in_array($route, ['admin_setting_general', 'admin_payment', 'admin_social_media_view', 'admin_social_media_create', 'admin_social_media_store', 'admin_social_media_edit', 'admin_currency_view', 'admin_currency_create', 'admin_currency_edit']) ? 'active' : '' }}">
                    ...
                    <div id="collapseSetting"
                        class="collapse {{ in_array($route, ['admin_setting_general', 'admin_payment', 'admin_social_media_view', 'admin_social_media_create', 'admin_social_media_store', 'admin_social_media_edit', 'admin_currency_view', 'admin_currency_create', 'admin_currency_edit']) ? 'show' : '' }}"
            ...
            @can('admin_insurance_view', 'admin_insurance_create')
                <li
                    class="nav-item {{ $route == 'admin_insurance_view' || $route == 'admin_insurance_create' ? 'active' : '' }}">
                    ...
                    <div id="collapseInsurance"
                        class="collapse {{ $route == 'admin_insurance_view' || $route == 'admin_insurance_create' ? 'show' : '' }}"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @can('admin_freight_view', 'admin_freight_create')
                <li
                    class="nav-item {{ $route == 'admin_freight_view' || $route == 'admin_freight_create' ? 'active' : '' }}">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFreight"
                        aria-expanded="true" aria-controls="collapseFreight">
                        <i class="fas fa-folder"></i>
                        <span>Freight</span>
                    </a>
                    <div id="collapseFreight"
                        class="collapse {{ $route == 'admin_freight_view' || $route == 'admin_freight_create' ? 'show' : '' }}"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @can('admin_inspection_view', 'admin_inspection_create')
                <!-- Inspection -->
                <li
                    class="nav-item {{ $route == 'admin_inspection_view' || $route == 'admin_inspection_create' ? 'active' : '' }}">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseInspection"
                        aria-expanded="true" aria-controls="collapseInspection">
                        <i class="fas fa-folder"></i>
                        <span>Inspection</span>
                    </a>
                    <div id="collapseInspection"
                        class="collapse {{ $route == 'admin_inspection_view' || $route == 'admin_inspection_create' ? 'show' : '' }}"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @can('permissions.index', 'permissions.create', 'permissions.edit')
                <li
                    class="nav-item {{ $route == 'permissions.index' || $route == 'permissions.create' || $route == 'permissions.edit' ? 'active' : '' }}">
                    ...
                    <div id="collapsePermissions"
                        class="collapse {{ $route == 'permissions.index' || $route == 'permissions.create' || $route == 'permissions.edit' ? 'show' : '' }}"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                ...
                @can('roles.index', 'roles.create', 'roles.edit', 'admin_users.index')
                    <li
                        class="nav-item {{ $route == 'roles.index' || $route == 'roles.create' || $route == 'roles.edit' ? 'active' : '' }}">
                        ...
                        <div id="collapseRoles"
                            class="collapse {{ $route == 'roles.index' || $route == 'roles.create' || $route == 'roles.edit' ? 'show' : '' }}"
                            aria-labelledby="headingPages" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                @can('permissions.create')
                ...
                <!-- Page Settings -->
                @can('admin_page_home_edit', 'admin_page_about_edit', 'admin_page_blog_edit', 'admin_page_faq_edit',
                    'admin_page_contact_edit', 'admin_page_pricing_edit', 'admin_page_listing_brand_edit',
                    'admin_page_listing_location_edit', 'admin_page_listing_edit', 'admin_page_term_edit',
                    'admin_page_privacy_edit', 'admin_page_other_edit')
                    <li
                        class="nav-item {{ $route == 'admin_page_home_edit' || $route == 'admin_page_about_edit' || $route == 'admin_page_blog_edit' || $route == 'admin_page_faq_edit' || $route == 'admin_page_contact_edit' || $route == 'admin_page_term_edit' || $route == 'admin_page_privacy_edit' || $route == 'admin_page_other_edit' || $route == 'admin_page_pricing_edit' || $route == 'admin_page_listing_brand_edit' || $route == 'admin_page_listing_location_edit' || $route == 'admin_page_listing_edit' ? 'active' : '' }}">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse"
                            data-target="#collapsePageSettings" aria-expanded="true" aria-controls="collapsePageSettings">
                            <i class="fas fa-folder"></i>
                            <span>{{ PAGE_SETTINGS }}</span>
                        </a>
                        <div id="collapsePageSettings"
                            class="collapse {{ $route == 'admin_page_home_edit' || $route == 'admin_page_about_edit' || $route == 'admin_page_blog_edit' || $route == 'admin_page_faq_edit' || $route == 'admin_page_contact_edit' || $route == 'admin_page_term_edit' || $route == 'admin_page_privacy_edit' || $route == 'admin_page_other_edit' || $route == 'admin_page_pricing_edit' || $route == 'admin_page_listing_brand_edit' || $route == 'admin_page_listing_location_edit' || $route == 'admin_page_listing_edit' ? 'show' : '' }}"
                            aria-labelledby="headingPages" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                @can('admin_page_contact_edit')
                                    <a class="collapse-item"
                                        href="{{ route('admin_page_contact_edit') }}">{{ CONTACT }}</a>
                                @endcan
                                @can('admin_page_pricing_edit')
                                    <a class="collapse-item"
                                        href="{{ route('admin_page_pricing_edit') }}">{{ PRICING }}</a>
                                @endcan
                                @can('admin_page_listing_brand_edit')
                                    <a class="collapse-item"
                                        href="{{ route('admin_page_listing_brand_edit') }}">{{ LISTING_BRAND }}</a>
                                @endcan
                                @can('admin_page_listing_location_edit')
                                    <a class="collapse-item"
                                        href="{{ route('admin_page_listing_location_edit') }}">{{ LISTING_LOCATION }}</a>
                                @endcan
                                @can('admin_page_listing_edit')
                                    <a class="collapse-item"
                                        href="{{ route('admin_page_listing_edit') }}">{{ LISTING }}</a>
                                @endcan
                                @can('admin_page_term_edit')
                                    <a class="collapse-item"
                                        href="{{ route('admin_page_term_edit') }}">{{ TERMS_AND_CONDITIONS }}</a>
                                @endcan
                                @can('admin_page_privacy_edit')
                                    <a class="collapse-item"
                                        href="{{ route('admin_page_privacy_edit') }}">{{ PRIVACY_POLICY }}</a>
                                @endcan
                ...
                @can('admin_listing_brand_view', 'admin_listing_location_view', 'admin_amenity_view', 'admin_listing_view')
                    <li
                        ...
                        <div id="collapseListing"
                            class="collapse {{ $route == 'admin_amenity_view' || $route == 'admin_amenity_create' || $route == 'admin_amenity_edit' || $route == 'admin_listing_brand_view' || $route == 'admin_listing_brand_create' || $route == 'admin_listing_brand_edit' || $route == 'admin_listing_location_view' || $route == 'admin_listing_location_create' || $route == 'admin_listing_location_edit' || $route == 'admin_listing_view' || $route == 'admin_listing_create' || $route == 'admin_listing_edit' ? 'show' : '' }}"
                            aria-labelledby="headingPages" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                @can('admin_listing_brand_view')
                                    <a class="collapse-item"
                                        href="{{ route('admin_listing_brand_view') }}">{{ LISTING_BRAND }}</a>
                                @endcan
                                @can('admin_listing_location_view')
                                    <a class="collapse-item"
                                        href="{{ route('admin_listing_location_view') }}">{{ LISTING_LOCATION }}</a>
                                @endcan
                                ...
                                @can('admin_amenity_view')
                                    <a class="collapse-item"
                                        href="{{ route('admin_amenity_view') }}">{{ LISTING_AMENITY }}</a>
                                @endcan
                ...
                @can('admin_offer_managment_view', 'admin_offer_managment_edit')
                    <li
                        class="nav-item {{ $route == 'admin_offer_managment_view' || $route == 'admin_offer_managment_edit' ? 'active' : '' }}">
                ...
                @endcan
                @can('admin_listing_option_service_view', 'admin_listing_option_service_create',
                    'admin_listing_option_service_store', 'admin_listing_option_service_edit',
                    'admin_listing_option_service_update')
                    <li
                        class="nav-item {{ $route == 'admin_listing_option_service_view' || $route == 'admin_listing_option_service_create' || $route == 'admin_listing_option_service_edit' || $route == 'admin_listing_option_service_store' || $route == 'admin_listing_option_service_update' ? 'active' : '' }}">
                        ...
                        <div id="collapseWebsite"
                            class="collapse {{ $route == 'admin_listing_option_service_view' || $route == 'admin_listing_option_service_create' || $route == 'admin_listing_option_service_edit' || $route == 'admin_listing_option_service_store' || $route == 'admin_listing_option_service_update' ? 'show' : '' }}"
                            aria-labelledby="headingPages" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <a class="collapse-item" href="{{ route('admin_listing_option_service_view') }}">List Option
                                    Services </a>
                                <a class="collapse-item" href="{{ route('admin_listing_option_service_create') }}">Create
                                    Option Service</a>
                            </div>
                        </div>
                    </li>
                ...
                @can('admin_shippment_requests')
                    <li class="nav-item {{ $route == 'admin_shippment_requests' ? 'active' : '' }}">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse"
                            data-target="#collapseShippingRequest" aria-expanded="true"
                            aria-controls="collapseShippingRequest">
                            <i class="fas fa-folder"></i>
                            <span>{{ SHIPPMENT_SECTION }}</span>
                        </a>
                        <div id="collapseShippingRequest"
                            class="collapse {{ $route == 'admin_shippment_requests' ? 'show' : '' }}"
                            aria-labelledby="headingPages" data-parent="#accordionSidebar">
                            {{-- <div class="bg-white py-2 collapse-inner rounded">
                                <a class="collapse-item" href="{{ route('admin_shippment_requests') }}">Shippment
                                    Requests</a>

                                <a class="collapse-item">Upload Paid Invoices</a>
                            </div> --}}
                            <div class="bg-white py-2 collapse-inner rounded">
                                <a class="collapse-item" href="{{ route('admin_shippment_requests') }}">Shippment
                                    Requests</a>
                                <a class="collapse-item" href="{{ route('admin_see_upload_invoices') }}">
                                    Paid Invoices</a>
                            </div>
                ...
                @can('services.index')
                    <li class="nav-item {{ $route == 'services.index' ? 'active' : '' }}">
                        ...
                        <div id="collapseServices" class="collapse {{ $route == 'admin_shippment_requests' ? 'show' : '' }}"
                            aria-labelledby="headingPages" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    ...
                                    <img class="img-profile rounded-circle"
                                        src="{{ asset('uploads/user_photos/' . $user->photo) }}">
                                </a>
                    ...
                    if (input.files) {
                        ...
                        for (let i = 0; i < filesAmount; i++) {
                            ...
                            reader.onload = function(event) {
                                ...
                                const closeButton = $('<button class="remove-image">X</button>').click(
                                    function() {
                                        $(this).parent().remove();
                                    });
                                const dragHandle = $('<div class="drag-handle">Drag</div>');
                                const imgContainer = $('<div class="image-container">').append(dragHandle)
                                    .append(img).append(closeButton);
