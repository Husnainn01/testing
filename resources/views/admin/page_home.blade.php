...
@php $slider=App\Models\Slide::where('id',1)->first();
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-12">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="p8_tab" data-toggle="pill" href="#p8" role="tab" aria-controls="p8" aria-selected="false">{{Slider}}</a>
                        </div>
                    </div>
                    <div class="col-md-9 col-sm-12">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade " id="p8" role="tabpanel" aria-labelledby="p8_tab">
                                ...
                                <!-- Tab Content -->
                                <div class="form-group">
                                    <label for="">Sllide1</label>
                                    <img src="{{ asset('uploads/sliders/' . ($slider->slide1 ?? '')) }}">
                                    @if($slider->slide1!='') 
                                ...
                                <div class="form-group">
                                    <label for="">Sllide1</label>
                                    <img src="{{ asset('uploads/sliders/' . ($slider->slide2 ?? '')) }}">
                                    @if($slider->slide2 !='') 
                                    <span>Update Image</span>
                                    @endif
                                ...
                                <div class="form-group">
                                    <label for="">Sllide3</label>
                                    <img src="{{ asset('uploads/sliders/' . ($slider->slide3 ?? '')) }}">
                                    @if($slider->slide3 !='') 
                                    <span>Update Image</span>
                                    @endif
                                ...
                                <div class="form-group">
                                    <label for="">Sllide4</label>
                                    <img src="{{ asset('uploads/slider/s' . ($slider->slide4 ?? '')) }}">
                                    @if($slider->slide4 !='') 
                                    <span>Update Image</span>
                                    @endif
                                ...
                                <div class="form-group">
                                    <label for="">Sllide5</label>
                                    <img src="{{ asset('uploads/slider/s' . ($slider->slide5 ?? '')) }}">
                                    @if($slider->slide5 !='') 
                                    @endif
                                    <span>Update Image</span>
