        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="listing_brand_name" required class="form-control" value="{{ $listing_brand->listing_brand_name }}" autofocus>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="file" required name="listing_brand_photo">
                    </div>
                </div>
            </div>
            <div class="card-header py-3">
