...
@section('content')
    @php
        ...
        $fueltype = \App\Models\listing::distinct()->orderBy('listing_fuel_type', 'asc')->pluck('listing_fuel_type');
        $seat = \App\Models\listing::distinct()->orderBy('listing_seat', 'asc')->pluck('listing_seat');
        $body = \App\Models\listing::distinct()->orderBy('listing_body', 'asc')->pluck('listing_body');
        $price = \App\Models\listing::distinct()->orderBy('listing_price', 'asc')->pluck('listing_price');
        ...
        $mileage = \App\Models\listing::distinct()->orderBy('listing_mileage', 'asc')->pluck('listing_mileage');
        $door = \App\Models\listing::distinct()->orderBy('listing_door', 'asc')->pluck('listing_door');
        ...
        <div class="container-fluid">
            <div class="row left-sidebar">
                ...
                <div class="col-md-2 order-2 order-sm-2  order-md-1 first-side"
                    style="position: sticky;top: -1800px !important;padding-left: 0;padding-right: 0;">
                ...
                <div class="col-md-8 order-1 order-sm-12 order-lg-2 order-md-2 pl-md-5 pl-lg-5 px-sm-5">
                    <form action="{{ route('mainfilter') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row header-search-box header-search-box_main" style="margin-top:-72px;">
                                ...
                                <div id="main_filter_body" class="row p-3 search-box shadow rounded-bottom-2"
                                    ...
                                    <div class="col-md-4 px-1">
                                        ...
                                        <select name="brands" id="" class="w-100 form-select">
                                            ...
                                            @foreach ($brands as $branditem)
                                                <option value="{{ $branditem->id }}"
                                                    @if ($brand == $branditem->id) selected @endif>
                                    ...
                                    <div class="col-md-4 px-1">
                                        ...
                                        <select name="condition" id="" class="w-100 form-select  mt-xs-3">
                                            ...
                                            <option value="New car" @if ($condition == 'New car') selected @endif>New
                                                Cars</option>
                                            <option value="Used car" @if ($condition == 'Used car') selected @endif>Used
                                                Cars</option>
                                    ...
                                    <div class="col-md-4 px-1 my-3">
                                        ...
                                        <select name="status" id="" class="w-100 form-select">
                                            ...
                                            <option value="in_stock" @if ($status == 'in_stock') selected @endif>In
                                                Stock</option>
                                            <option value="reserved" @if ($status == 'reserved') selected @endif>
                                                Reserved</option>
                                            <option value="sold" @if ($status == 'sold') selected @endif>Sold
                                            </option>
                                    ...
                                    <div class="col-md-4 px-1 my-3">
                                        ...
                                        <select name="steering" id="" class="w-100 form-select">
                                            ...
                                            <option value="left steering"
                                                @if ($steering == 'left steering') selected @endif>Left Steering</option>
                                            <option value="right_steering"
                                                @if ($steering == 'right_steering') selected @endif>Right Steering</option>
                                    ...
                                    <div class="col-md-4 my-3  px-1">
                                        ...
                                        <select name="seats" id="" class="w-100 form-select">
                                            ...
                                            @foreach ($seat as $item)
                                                <option value="{{ $item }}"
                                                    @if ($seats == $item) selected @endif>{{ $item }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="col-md-4 px-1">
                                        ...
                                        <select name="body_type" id="" class="w-100 form-select  mt-xs-3">
                                            ...
                                            @foreach ($body as $item)
                                                <option value="{{ $item }}"
                                                    @if ($body_type == $item) selected @endif>{{ $item }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="col-md-4 ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 px-1 "> <select name="min_price" id=""
                                                    class="w-100 form-select  mt-xs-3">
                                                    <option value="">Min Price</option>
                                                    @forelse ($price as $item)
                                                        <option value="{{ $item }}"
                                                            @if ($min_price == $item) selected @endif>
                                                            {{ $item }}</option>
                                                    @empty
                                                        <option value="">Empty</option>
                                                    @endforelse
                                            ...
                                            <div class="col-md-6 px-1 "> <select name="max_price" id=""
                                                    class="w-100 form-select  mt-xs-3">
                                                    <option value="">Max Price</option>
                                                    @forelse ($price as $item)
                                                        <option value="{{ $item }}"
                                                            @if ($max_price == $item) selected @endif>
                                                            {{ $item }}</option>
                                                    @empty
                                                        <option value="">Empty</option>
                                                    @endforelse
                                        ...
                                        <div class="row">
                                                ...
                                                <select name="from_year" id=""
                                                    ...
                                                    @foreach ($modelYears as $yearitem)
                                                        <option value="{{ $yearitem }}"
                                                            @if ($min_year == $yearitem) selected @endif>
                                                            {{ $yearitem }}</option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-6 px-1 ">
                                                <select name="to_year" id="" class="w-100 form-select">
                                                    ...
                                                    @foreach ($modelYears as $yearitem)
                                                        <option value="{{ $yearitem }}"
                                                            @if ($max_year == $yearitem) selected @endif>
                                                            {{ $yearitem }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-4 my-3 ">
                                        <div class="row">
                                            <div class="col-md-6 px-1 "> <select name="min_mileage" id=""
                                                    class="w-100 form-select  ">
                                                    <option value="">Mine.Mileage</option>
                                                    @forelse ($mileage as $item)
                                                        <option value="{{ $item }}"
                                                            @if ($min_mileage == $item) selected @endif>
                                                            {{ $item }}</option>
                                            ...
                                            <div class="col-md-6  px-1"> <select name="max_mileage" id=""
                                                    class="w-100 form-select  mt-xs-3">
                                                    <option value="">Max.Mileage</option>
                                                    @forelse ($mileage as $item)
                                                        <option value="{{ $item }}"
                                                            @if ($max_mileage == $item) selected @endif>
                                                            {{ $item }}</option>
                                    ...
                                    <div class="col-md-4 my-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 px-1 "> <select name="min_engine_capacity"
                                                    id="" class="w-100 form-select ">
                                                    <option value="">Min-Capacity</option>
                                                    @foreach ($enginecapacity as $item)
                                                        <option value="{{ $item }}"
                                                            @if ($min_engine_capacity == $item) selected @endif>
                                                            {{ $item }}</option>
                                                    @endforeach

                                                </select></div>
                                            <div class="col-md-6 px-1 "> <select name="max_engine_capacity"
                                                    id="" class="w-100 form-select  mt-xs-3">

                                                    <option value="">Max-Capacity</option>
                                                    @foreach ($enginecapacity as $item)
                                                        <option value="{{ $item }}"
                                                            @if ($max_engine_capacity == $item) selected @endif>
                                                            {{ $item }}</option>
                                                    @endforeach
                                                </select></div>
                                        </div>
                                    ...
                                    <div class="col-md-4 px-1 my-3">
                                        ...
                                        <select name="fuel_type" id="" class="w-100 form-select">
                                            ...
                                            @foreach ($fueltype as $items)
                                                <option value="{{ $items }}"
                                                    @if ($fuel_type == $items) selected @endif>
                                                    {{ $items }}</option>
                                            @endforeach
                                    ...
                                    <div class="col-md-4 px-1 my-2">
                                        ...
                                        <select name="transmission" id="" class="w-100 form-select">
                                            ...
                                            <option value="automatic" @if ($transmission == 'automatic') selected @endif>
                                                Automatic</option>
                                            <option value="manual" @if ($transmission == 'manual') selected @endif>
                                                Manual</option>
                                    ...
                                    <div class="col-md-8 px-1 my-2">
                                        ...
                                        <select name="color" id="" class="w-100 form-select">
                                            ...
                                            @forelse ($color as $item)
                                                <option value="{{ $item }}"
                                                    @if ($colorItem == $item) selected @endif>{{ $item }}
                                                </option>
                                            @empty
                                                <option value="">Empty</option>
                                            @endforelse
                            ...
                            <div class="some-list-2">
                                <div class="row cars-box'">
                                    @foreach ($data as $items)
                                        @php
                                            $location = DB::table('listing_locations')
                                                ->where('id', $items->listing_location_id)
                                                ->first();
                                        ...
                                        <div class="col-md-12   mb-2 ">
                                            ...
                                            <div class="row mt-2 cars-box shadow " style="  border-radius: 10px;"
                                                data-name="{{ $items->listing_name }}"
                                                data-location="{{ $location->listing_location_name }}"
                                                data-mileage="{{ $items->listing_mileage }}"
                                                data-transmission="{{ $items->listing_transmission }}"
                                                data-fuel="{{ $items->listing_fuel_type }}"
                                                data-steering="{{ $items->steering }}"
                                                data-body="{{ $items->listing_body }}"
                                                data-seat="{{ $items->listing_seat }}"
                                                data-engine="{{ $items->listing_engine_capacity }}"
                                                data-model="{{ $items->listing_model_year }}"
                                                data-door="{{ $items->listing_door }}"
                                                data-color="{{ $items->listing_exterior_color }}"
                                                data-photo="{{ $items->listing_featured_photo }}"
                                                data-price="{{ $items->listing_price }}"
                                                data-car_id="{{ $items->id }}"
                                                data-status="{{ $items->listing_stock_status }}">
                                                <div class="col-md-3 col-lg-3 col-sm-12 p-md-0 p-lg-0 img-responsive"
                                                    style="background:url('{{ asset('/uploads/listing_featured_photos/' . $items->listing_featured_photo) }}');
                    ...
                    border-radius: 5px 0px 0px 5px;">
                                                    ...
                                                    <a class="text-dark w-100 d-flex flex-column justify-content-between h-100"
                                                        ...
                                                        @if ($items->listing_stock_status == 'in_stock')
                                                            <span
                                                                class="badge position-absolute start-0 p-2 text-light primary top-0">In
                                                                Stock</span>
                                                        @elseif($items->listing_stock_status == 'reserved')
                                                            <span
                                                                class="badge position-absolute start-0 p-2 text-light primary top-0">Reserved</span>
                                                        @else
                                                            <span
                                                                class="badge position-absolute start-0 p-2 text-light primary top-0">SOLD</span>
                                                        @endif
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                ...
                                                                <h6 class="m-0 font-weight-bold">
                                                                    {{ $items->listing_name }}</h6>
                                                                <ul class="list-unstyled p-0">

                                                                    <li><small class="pt-2 d-block"><span
                                                                                class="">Mileage:</span>{{ $items->listing_mileage }}</small>
                                                                    </li>
                                                                    <li><small><span
                                                                                class="">Transmission:</span>{{ $items->listing_transmission }}</small>
                                                                    </li>
                                                                    <li><small><span class="">Fuel
                                                                                Type:</span>{{ $items->listing_fuel_type }}</small>
                                                                    </li>
                                                                    <li><small><span
                                                                                class="">Steering:</span>{{ $items->steering }}</small>
                                                                    </li>
                                                            ...
                                                            <div class="col-md-4 py-2"><small
                                                                    class="text-right d-block "><img
                                                                        src="{{ asset('uploads/listing_location_photos/' . $location->listing_location_photo) }}"
                                                                        width="20" alt="">
                                                                    {{ $location->listing_location_name }}</small></div>
                                                ...
                                                <div class="col-md-3 col-lg-3 col-sm-12">
                                                    ...
                                                    <h5>
                                                        ...
                                                        <small class="float-right text-danger fs-sm mt-2">
                                                            @php
                                                                ...
                                                                $formattedPrice =
                                                                    strlen($listingPrice) > 7
                                                                        ? substr($listingPrice, 0, 7)
                                                                        : $listingPrice;
                                                                ...
                                                                @php
                                                                    ...
                                                                    if (is_numeric($formattedPriceAsFloat)) {
                                                                        $convertedPrice = round(
                                                                            $formattedPriceAsFloat *
                                                                                session()->get('currency_value'),
                                                                            2,
                                                                        );
                                                                        echo session()->get('currency_symbol') .
                                                                            $convertedPrice;
                                                                    } else {
                                                    ...
                                                    <h5 class="mt-2"><small class="float-start">Total
                                                            Price</small><small class="float-right text-danger"
                                                            data-toggle="modal">ASK</small></h5>
                                                    <a type="button"
                                                        href="{{ route('front_listing_detail', ['slug' => $items->listing_slug]) }}"
                                                        class="btn btn-primary my-2 w-100 send-offer">
                                                        Send Offer
                                                    </a>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="box-holder position-relative">
                                    <img id="photo" src="{{ asset('assets/images/car (1).jpg') }}" class="w-100"
                                        alt="">
                                    {{-- <span class="badge bg-danger position-absolute start-0 p-2 text-light">In
                                Stock</span> --}}
                                    <h2 class="badge position-absolute start-0 p-2 text-light primary top-0"
                                        id="status_value"></h2>
                            ...
                            <div class="col-md-7 col-lg-7 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h5 class="text-right" id="location"><img
                                                src="{{ asset('assets/images/flags/AO.svg') }} " class="flag"
                                                alt=""></h5>
                                    </div>
                                ...
                                <form id="quote-form" action="{{ route('get_qoute') }}" method="POST">
                                    ...
                                    @if (Auth::check())
                                        <div class="row border-bottom py-2">
                                            ...
                                            <div class="col-md-8 col-sm-12 col-lg-8">
                                                <h6 class="orange text-right">
                                                    <select id="freight" class="form-control" name="freight"
                                        ...
                                        height: 33px;">
                                                        ...
                                                        @if (sizeof($freights))
                                                            @foreach ($freights as $freightOption)
                                                                <option value="{{ $freightOption->id }}"
                                                                    data-price="{{ $freightOption->price }}">
                                                        ...
                                                        @if (sizeof($insurances))
                                                            @foreach ($insurances as $insurance)
                                                                <option value="{{ $insurance->id }}"
                                                                    ...
                                                                    {{ $insurance->insurance_type }}({{ $insurance->price }})
                                                                </option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                        ...
                                        <div class="row border-bottom py-2">
                                            ...
                                            <div class="col-md-8 col-sm-12 col-lg-8">
                                                <h6 class="orange text-right">
                                                    <select name="inspection_certificate" id="inspection_certificate"
                                                        ...
                                                        @if (sizeof($inspection_certificates))
                                                            @foreach ($inspection_certificates as $inspection_certificate)
                                                                <option value="{{ $inspection_certificate->id }}"
                                                                    ...
                                                                    {{ $inspection_certificate->inspection_type }}({{ $inspection_certificate->price }})
                                                                </option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                        ...
                                        <div class="row  py-2 d-block">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-lg-6">
                                                <small class="text-danger font-weight-bold d-block"
                                                    id="total_price_text"></small>
                                                <input type="text" name="total_price" hidden id="total_price">
                                            </div>
                                        </div>
                                    @else
                                        <a class="btn btn-primary w-100 mt-3"
                                            href="{{ route('customer_login') }}">Login</a>
                                    @endif
                                    @if (Auth::check())
                                        <input type="text" hidden name="name" class="form-control"
                                            value="{{ $userdata->name }}" placeholder="Enter Your Full Name" required>
