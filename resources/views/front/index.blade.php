                                ...
                                <div id="homefilter-body">
                                    ...
                                    <!--price-->
                                        <div class="col-md-3 col-6 col-sm-6">
                                            ...
                                            <input class="form-select" type="number" name="price" id="pricefrom" min="0"
                                                   placeholder="Price" style="border-radius: 0;">
                                        </div>
                                        <!--count-->
                        ...
                        <div class="row">
                            ...
                            <div class="row my-5 border-bottom border-1 best-seller">
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-12 my-3">
                                    <div class="row ">
                                        <div class="col-3">
                                            <img src="{{asset('images/truck.png')}}" alt="Car" class="custom-icon">
                                        </div>
                                        <div class="col-8">
                                            <ul class="list-unstyled ">
                                                <a href="#">
...
<style>
    ...
    .mob-hide .box-content {
        ...
        background: #FFF;
        flex-shrink: 0;
        border: none; /* Assuming you don't need a border, or update if you have a border style */
        margin: auto; /* Centering the box if needed */
        display: flex;
        flex-direction: column;
        justify-content: space-between;
        overflow: hidden; /* Ensuring content doesn't spill out */
        box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); /* Adding a subtle shadow for depth, adjust as needed */
    }
    ...
    @media (min-width: 1200px) and (max-width: 1919px) {
        .mob-hide .box-content {
            width: 260px; /* No change from your original */
    ...
    .reviews-container {
        width: 100%;
        font-family: Arial, sans-serif; /* Or any other font of your choice */
    }

    .review-item {
        display: flex;
        align-items: center;
        margin-bottom: 20px; /* Space between review items */
    }
    ...
    .review-content {
        border: 0px solid #ddd; /* Light grey border */
        border-radius: 4px;
        padding: 10px;
        width: calc(100% - 120px); /* Adjust based on image width and margins */
    }
    ...
    @media only screen and (max-width: 768px) {
        ...
        .col-3, .col-8 {
            flex: 0 0 100%; /* Stack the image and text on top of each other */
