                ...
                <div class="row ">
                    ...
                    <div class="col-md-8 order-1 order-sm-1 order-lg-1 search-box-wrapper px-md-5 px-lg-5 px-sm-0">
                        ...
                        <div class="row">
                                        ...
                                        <div class="border rounded box box-content position-relative">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="details" style="padding-bottom: 36px !important;">
                                                    ...
                                                    <span>{{ $carsitems->listing_fuel_type }}</span>
                                                    <span>{{ $carsitems->listing_engine_capacity }} cc</span>
                            ...
                            <div class="mob-hide d-block w-100 px-3 pagination">
                                                    ...
                                                    <div class="accordion w-100" id="accordionExample">
                                                        ...
                                                        <div class="card row ">
                                                                ...
                                                                <h2 class="mb-0">
                                                                    <a class="accordo-text btn-link btn-block text-left collapsed font-weight-bold"
                                                                       ...
                                                                       aria-controls="collapse1">
                                                                        Q1. How do I buy a vehicle/machinery from SS
                                                                        Japan
                                                                        Limited?
                                                                    </a>
                                                                </h2>
                                                            ...
                                                            <div id="collapse1" class="collapse"
                                                                ...
                                                                <div class="card-body">
                                                                    Once you have provided us with the necessary
                                                                    information
                                                                    regarding the vehicle you want, and have made the
                                                                    initial
                                                                    auction deposit, we can start searching and send you
                                                                    possible matches daily. Once you give us a go ahead
                                                                    to
                                                        ...
                                                        <div class="card row ">
                                                                ...
                                                                <h2 class="mb-0">
                                                                    <a class="accordo-text  btn-link btn-block text-left collapsed font-weight-bold"
                                                                       ...
                                                                       aria-controls="collapse2">
                                                                        Q2. Who takes care of getting my car ready for
                                                                        export
                                                                        and shipping it?
                                                                    </a>
                                                                </h2>
                                                            ...
                                                            <div id="collapse2" class="collapse"
                                                                 ...
                                                                 data-parent="#accordionExample">
                                                                <div class="card-body">
                                                                    We will prepare your vehicle for export to any port
                                                                    of your
                                                                    choosing and will handle all the booking and
                                                                    shipping
                                                                    process from Japan. Depending on your country and
                                                                    method of
                                                        ...
                                                        <div class="card row ">
                                                            ...
                                                            <div id="collapse3" class="collapse"
                                                                 ...
                                                                 data-parent="#accordionExample">
                                                                <div class="card-body">
                                                                    All vehicles sold at auction are given an overall
                                                                    grade by
                                                                    the independent auction engineers that inspect them.
                                                                    Grades
                                                                    can range from 0 to 9 but most auctions only use 0
                                                                    to 5.
                                                                    This number is shown in either the top left or top
                                                                    right of
                                                                    the auction sheet.
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="card row ">
                                                                ...
                                                                <h2 class="mb-0">
                                                                    <a class="accordo-text  btn-link btn-block text-left collapsed font-weight-bold"
                                                                       ...
                                                                       aria-controls="collapse4">
                                                                        Q4. How can I confirm about the quality of the
                                                                        car?
                                                                    </a>
                                                                </h2>
                                                            </div>
                                                            ...
                                                            <div id="collapse4" class="collapse"
                                                                 ...
                                                                 data-parent="#accordionExample">
                                                                <div class="card-body">
                                                                    We thoroughly inspect every vehicle to ensure
                                                                    highest
                                                                    quality possible, and provide only the most recent
                                                                    pictures
                                                                    of the vehicles to our customers for their
                                                                    satisfaction.
                                                                    Furthermore, our agents guide you extensively about
                                                                    the
                                                        ...
                                                        <div class="card row ">
                                                                ...
                                                                <h2 class="mb-0">
                                                                    <a class="accordo-text  btn-link btn-block text-left collapsed font-weight-bold"
                                                                       ...
                                                                       aria-controls="collapse5">
                                                                        Q5. Does your buying team inspect the cars
                                                                        before
                                                                        bidding?
                                                                    </a>
                                                                </h2>
                                                            ...
                                                            <div id="collapse5" class="collapse"
                                                                 ...
                                                                 data-parent="#accordionExample">
                                                                <div class="card-body">
                                                                    Yes, we examine the car completely and once
                                                                    satisfied, we
                                            ...
                                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                                ...
                                                <div class="card row ">
                                                    ...
                                                    <div id="collapse1" class="collapse" aria-labelledby="heading1"
                                                         data-parent="#accordionExample">
                                                        <div class="card-body">
                                                            You are required to make the complete payment after the bid
                                                            is
                                            ...
                                            <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                                ...
                                                <div class="card row ">
                                                    ...
                                                    <div id="collapse2" class="collapse" aria-labelledby="heading2"
                                                         data-parent="#accordionExample">
                                                        <div class="card-body">
                                                            We will ship your vehicle as soon as you complete the
                                                            minimum
                                                            deposit for shipment. It is 50%~100% of the Total C&F, which
                                                            is
                                            ...
                                            <div class="tab-pane fade" id="pills-others" role="tabpanel"
                                                ...
                                                <div class="card row ">
                                                    ...
                                                    <div id="collapse3" class="collapse" aria-labelledby="heading3"
                                                         data-parent="#accordionExample">
                                                        <div class="card-body">
                                                            We cannot commit an accurate time of shipment as it depends
                                                            on
                                                            shipping schedule and availability of space. On an average,
                                                            it takes
                                                            4 to 6 weeks.
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="pills-howtopay" role="tabpanel"
                                                ...
                                                <div class="card row ">
                                                    <div class="card-header" id="heading4">
                                                        <h2 class="mb-0">
                                                            <a class="accordo-text  btn-link btn-block text-left collapsed font-weight-bold"
                                                               ...
                                                               data-target="#collapse4" aria-expanded="true"
                                                               aria-controls="collapse4">
                                                                Q3. How long does it take for the documents to reach my
                                                                country?
                                                            </a>
                                                        </h2>
                                                    </div>
                                                    ...
                                                    <div id="collapse4" class="collapse" aria-labelledby="heading4"
                                                         data-parent="#accordionExample">
                                                        <div class="card-body">
                                                            Once shipment has departed, Original BL Scan will be
                                                            supplied within
...
<style>
    .row {
        margin: 0 -15px;
    !important; /* Adjust the margin if necessary */
    }

    .col-md-4.col-sm-12.col-lg-3 {
        padding: 0 15px;
    !important; /* Adjust the padding if necessary */
        margin-bottom: 30px;
    ...
    .mob-hide .box-content .content .details span {
        ...
        margin: 0 5px !important; /* Half of the spacing you want between items and separators */
    }

    .mob-hide .box-content .content .details span:not(:first-child):not(:last-child)::before {
        content: '|' !important;
        color: #808080 !important; /* Adjust the color to match your design */
        padding-right: 5px !important; /* The other half of the spacing */
    ...
    .mob-hide .box-content .content .price {
        display: flex !important;
        flex-direction: column !important;
        align-items: start !important; /* Aligns the text to the left */
        margin-top: 8px !important; /* Gives some space above the price */
        padding-top: 8px !important; /* Gives some space within the price section */
        border-top: 1px solid #ccc !important; /* Adds a border on top of the price section */
        padding: 5px 10px !important;
    }

    .mob-hide .box-content .content .price span {
        font-weight: bold !important;
        color: #808080 !important; /* Dark grey color for the price text */
        font-size: 1.25rem !important; /* Larger font size for the price */
    }

    .mob-hide .box-content .content .price .update {
        font-size: 0.7rem !important;
        color: #808080 !important; /* Light grey color for the update text */
        align-self: start !important; /* Align the update text to the left */
    }
    ...
    .mob-hide .box-content button {
        ...
        padding: 0 !important; /* Padding is not needed since height is explicitly set */
        display: block !important; /* To ensure the width is respected */
        margin-left: auto !important;
        margin-right: auto !important;
        margin-top: 8px !important;
        margin-bottom: 0 !important; /* Remove bottom margin if you want the button to align with the card's bottom edge */
    }

    .mob-hide .box-content button:hover {
        background-color: #250202 !important; /* Darken the button on hover - adjust color as needed */
    }
    ...
    .favorite-button {
        ...
        z-index: 5; /* Higher than the image but lower than the badge */
    }
    ...
    .favorite-button i:hover {
        color: #e00; /* Change color on hover */
        cursor: pointer;
    ...
    .best-seller h2 {
        ...
        color: #333; /* Dark font color for the title */
        padding-bottom: 0.5rem; /* Space below the title */
    }

    .best-seller .col-md-4, .best-seller .col-lg-4, .best-seller .col-sm-12 {
        padding: 1rem; /* Padding around the items */
    }
    ...
    .best-seller ul li {
        padding: 0.25rem 0; /* Spacing for list items */
        font-size: 0.9rem; /* Font size for list items */
    }

    /* Style for the car type labels (e.g., SUV, Sedan) */
    .best-seller .col-3 {
        font-size: 0.9rem; /* Font size for type labels */
        text-transform: uppercase; /* Uppercase text for type labels */
        font-weight: bold; /* Bold text for type labels */
        color: #731718; /* Text color for type labels */
        margin-right: 0.5rem; /* Space between icon and type label */
    }
