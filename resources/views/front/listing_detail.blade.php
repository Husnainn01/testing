                    ...
                    <form id="quote-form" action="{{ route('get_qoute') }}" method="POST">
                            ...
                            <div class="col-lg-6">
                                <div class="row">
                                    ...
                                    @auth
                                        ...
                                        <input type="hidden" class="form-fields" name="car_id"
                                            value="{{ $detail->id }}">
                                        <input type="hidden" class="form-fields" id="car_listing_price"
                                            value="{{ $detail->listing_price }}">
                                    @endauth
                                    {{--                                </div> --}}
                                    <div class="col-5 pt-3 px-0">
                                        Total Price:
                            ...
                            <div class="col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 px-1 pl-2 mt-2">
                                        ...
                                        <Input class="form-fields" name="name" id="name"
                                            placeholder="Name"></Input>
                                    </div>
                                    <div class="col-sm-6 px-1 pl-2 mt-2">
                                        <label for="" class="form-label">Email <span
                                                class="text-danger">*</span></label>
                                        <Input class="form-fields" name="email" id="email"
                                            placeholder="Email"></Input>
                                    </div>
                                    <div class="col-sm-6 px-1 pl-2 my-2">
                                        <label for="" class="form-label">Tel <span
                                                class="text-danger">*</span></label>
                                        <Input class="form-fields" name="phone_no" id="phone_no"
                                    ...
                                    <div class="col-sm-6 px-1 pl-2">
                                        <label for="" class="form-label">City <span
                                                class="text-danger">*</span></label>
                                        <Input class="form-fields" name="city" id="city"
                                            placeholder="City"></Input>
                                    </div>
                                    <div class="col-sm-6 px-1 pl-2 mt-sm-0 mt-2">
                                        <label for="" class="form-label">Address <span
                                                class="text-danger">*</span></label>
                                        <Input class="form-fields" name="address" id="address"
                                            placeholder="Address"></Input>
                                    </div>
                                    <div class="col-12 px-1 pl-2 mt-2">
                                        <button
                                            class="form-btn py-2 rounded mt-3 d-flex align-items-center justify-content-center">
                        ...
                        @if (Auth::check())
                            ...
                            <div class="row border-bottom p-3 bg-white">
                                ...
                                <div class="col-md-6 col-sm-12 col-lg-6">
                                    <h6 class="orange text-right" id="total_price_text">${{ $detail->listing_price }}
                                    </h6>
                            ...
                            @else
                                <a class="btn btn-primary w-100 my-3 mob-spacing"
                                ...
                                <b>
                                    <select name="port" id="port" class="post-select text-sm py-2">
                                        @foreach ($listing_ports as $port)
                                            <option value="{{ $port->id }}" data-price="{{ $port->price }}"
                                                data-name="{{ $port->name }}">{{ $port->name }}</option>
                                        @endforeach
                                    </select>
                                </b>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="listing-sidebar" id="sticky_sidebar">
                    ...
                    <div class="ls-widget">
                        ...
                        @if ($agent_detail->facebook != '' || $agent_detail->twitter != '' || $agent_detail->linkedin != '' || $agent_detail->pinterest != '' || $agent_detail->youtube != '')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            portSelect.addEventListener('change', function() {
                ...
                if (selectedPortPriceElement) selectedPortPriceElement.textContent =
                    `$${portPrice.toFixed(2)}`;
