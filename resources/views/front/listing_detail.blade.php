            ...
            <!-- Carousel -->
                <div id="carousel" class="carousel slide gallery" data-ride="carousel">
                    <div class="carousel-inner position-relative ">
                        ...
                        @endif
                        <span class="water-mark" style="background-color:black;opacity: 0.6">1/{{$listing_photos->count()}}</span>
                        {{--                        <div class="water-mark"><h4>SS-Japan.com</h4></div>--}}
                    </div>
                                ...
                                @foreach ($row_photos as $row_index => $row)
                                    <div class="row mx-0">
                                        @foreach ($row as $photo_index => $photo)
                                            <div
                                                id="carousel-selector-{{ $photo_chunk_index * 8 + $row_index * 4 + $photo_index }}"
                ...
                <div class="row border-bottom my-3 pt-5 d-block" style="margin-top:-35px !important;">
                    <div class="col-md-6">
                        <h5>Share:
...
{{--                    </div>--}}
                    <div
                        ...
                        <p class="mb-0">{{$detail->listing_mileage}}</p><small>Mileage</small>
                    </div>
                    <div
                        class="col-md-2 col-sm-6 col-sm-6 col-lg-2 border-right specification border-dark text-center  p-md-0 p-lg-0 p-3">
                        <p class="mb-0">{{$detail->listing_model_year}}</p><small>Year</small>
                    </div>
                    <div
                        class="col-md-2 col-sm-6 col-sm-6 col-lg-2 border-right specification border-dark text-center  p-md-0 p-lg-0 p-3">
                        <p class="mb-0">{{$detail->listing_engine_capacity}}</p><small>Engine</small>
                    </div>
                    <div
                        class="col-md-2 col-sm-6 col-sm-6 col-lg-2 border-right specification border-dark text-center  p-md-0 p-lg-0 p-3">
                        <p class="mb-0">{{$detail->listing_transmission}}</p><small>Trans</small>
                    </div>
                    <div
                        class="col-md-3 col-sm-6 col-sm-6 col-lg-3 border-right specification border-dark text-center  p-md-0 p-lg-0 p-3">
                        <p class="mb-0">{{$listing_locations_car->listing_location_name}}</p><small>Location</small>
                    </div>
...
{{--                                    {{$detail->listing_type}}--}}
                        ...
                        <tr>
                            <td style="background: #EBF3FF;" class="text-left pl-2"><small>Registration<br>Year/Month</small></td>
                            <td class="text-left pl-2">
                                <small>-
                                    {{--                                    {{$detail->listing_type}}--}}
                                </small>
                        ...
                        <tr>
                            <td style="background: #EBF3FF;" class="text-left pl-2"><small>Manufacture<br>year/Month</small></td>
...
{{--                        </tr>--}}
            ...
            <div class="col-md-6 col-lg-6 col-sm-12 col-12  print_rit_50">
                <div class="row p-3 border-md-bottom border-lg-bottom ">
                    ...
                    <button class="btn btn-primary float-right" id="addToFavoritesBtn"
                            data-listing-id="{{ $detail->id }}" onclick="addToFavorites()">❤️ Add to Favorites
                    </button>
                    <h5 class="py-2 w-100">
            ...
            {{-- <p  class="orange">Auction Grade: 4</p> --}}
                ...
                <div class="container-fluid border rounded " style="background-color: #F6F6F6;">
                    ...
                    <span class="position-relative">
                        <h5 class="float-left">FOB Price:</h5>
                    </span>
                            </div>
                            <div class="col-md-6 col-sm-12 col-lg-6">
                                @auth
                                            ...
                                            @if(sizeof($freights))
                                                @foreach($freights as $freightOption)
                                                    <option value="{{$freightOption->id}}"
                                                            data-price="{{$freightOption->price}}">{{$freightOption->destination}}
                                                        ({{$freightOption->price}})
                                                    </option>
                                                @endforeach
                                            @endif
                                            ...
                                            @if(sizeof($insurances))
                                                @foreach($insurances as $insurance)
                                                    <option value="{{$insurance->id}}"
                                                            data-price="{{$insurance->price}}">{{$insurance->insurance_type}}
                                                        ({{$insurance->price}})
                                                    </option>
                                                @endforeach
                                            @endif
                    ...
                    <span>
                        <h4 class="float-left mr-3 font-weight-bold">Total Price</h4>
                                ...
                                @else
                                    <a class="btn btn-primary w-100 mt-3 mob-spacing"
                ...
                <span><textarea class="w-100 p-2 form-textarea" name="" id="" cols="30" rows="3"
                    ...
                    <p>Please note that it is the buyer's responsibility to confirm that the vehicle satisfies all
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="price">
                    ...
                    @else
                    {{ session()->get('currency_symbol') }}{{ number_format($detail->listing_price*session()->get('currency_value')) }}
                    @endif
                </div>
                <div class="location">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>{{ WEBSITE }}</td>
                                        <td class="website">
                                            <a href="{{ $detail->listing_website }}"
                                                target="_blank">{{ $detail->listing_website }}</a>
                                        </td>
                                    </tr>
                                    @endif
                        ...
                        <div class="ls-widget">
                            ...
                            <div class="agent">
                                ...
                                <div class="text">
                                    ...
                                    @endif
                                    <h3><a
                                            href="{{ route('front_listing_agent_detail',[$type,$agent_detail->id]) }}">{{ $agent_detail->name }}</a>
                                    </h3>
    ...
    <style>
        ...
        .carousel-indicators .active {
            background-color: #000; /* Black color for the active indicator */
        }
