...
<div class="col-md-6 col-lg-6 col-sm-12 col-12  print_rit_50">
    <div class="row p-3 border-md-bottom border-lg-bottom ">
        ...
        <button class="btn btn-primary float-right mx-4" id="addToFavoritesBtn" data-listing-id="{{ $detail->id }}" onclick="addToFavorites()"><i class="fa-regular fa-heart"></i> <span id="fav-text">Add to Favorites</span></button>
        <h5 class="py-2 w-100">
    ...
    <div class="container-fluid border rounded " style="background-color: #F6F6F6;">
        <form id="quote-form" action="{{ route('get_qoute') }}" method="POST">
            ...
            <div class="row border-bottom p-3">
                ...
                <div class="col-md-6 col-sm-12 col-lg-6">
                    <h6 class="orange text-right">
                        <select name="insurance" id="insurance" class="form-control" onchange="calculateTotal()">
            ...
            <div class="row border-bottom p-3">
                ...
                <div class="col-md-6 col-sm-12 col-lg-6">
                    <h6 class="orange text-right">
                        <select name="inspection_certificate" id="inspection_certificate" class="form-control" onchange="calculateTotal()">
                            <option disabled selected>Select </option>
            ...
            <div class="row border-bottom p-3">
                ...
                <div class="col-md-6 col-sm-12 col-lg-6">
                    <h6 class="orange text-right">
                        <input type="text" name="offer" class="form-control" required placeholder="Enter Your Offer">
                    </h6>
                </div>
            </div>
            @if(Auth::check())
            ...
            <div class="row border-bottom p-3 bg-white">
                ...
                @else
                    <a class="btn btn-primary w-100 mt-3 mob-spacing" href="{{route('customer_login')}}">Login</a>
                @endif
            </div>
        </form>
        ...
        <div class="row  p-3 ">
            <div class="col-md-6 col-sm-12 col-lg-6  py-sm-2">
                <span><input type="text" name="first_name" class="form-control py-sm-2 mob-spacing" placeholder="First Name">
                </span>
            </div>
            ...
            <div class="col-md-6 col-sm-12 col-lg-6  py-sm-2 mob-spacing">
                <span><input type="number" name="phone_no" class="form-control" placeholder="Phone number">
                </span>
            </div>
            <div class="col-md-6 col-sm-12 col-lg-6  py-sm-2 mob-spacing">
            ...
            <div class="col-md-12">
                <button type="submit" onclick="reloadPage()"
                    ...
                    style="background-color:#ff5500;">Send</button>
            </div>
        </div>
...
function addToFavorites() {
    ...
    .then(data => {
        ...
        $("#success-message").text('Your listing has been added to favorites');
