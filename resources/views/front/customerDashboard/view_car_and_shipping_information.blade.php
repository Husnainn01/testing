                                ...
                                <div class="card p-4 shadow">
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Receiver Name:</th>
                                                <td class="text-center">{{ $shippingOrder->receiver_default_name }}</td>
                                            </tr>
                                            <tr>
                                                <th>Receiver Email:</th>
                                                <td class="text-center">{{ $shippingOrder->receiver_default_email }}</td>
                                            </tr>
                                            <tr>
                                                <th>Receiver Company:</th>
                                                <td class="text-center">{{ $shippingOrder->receiver_default_company_name }}</td>
                                            </tr>
                                            <tr>
                                                <th>Receiver Phone Number:</th>
                                                <td class="text-center">{{ $shippingOrder->receiver_default_phone_number }}</td>
                                            </tr>
                                            <tr>
                                                <th>Status:</th>
                                ...
                                <div id="carousel" class="carousel slide gallery background-secondary" data-ride="carousel">
                                    <div class="carousel-inner">
                                        @php $key = 0; @endphp
                                            ...
                                            @php $key++; @endphp
                                            <div class="carousel-item {{ $key == 1 ? 'active' : '' }}" data-slide-number="1" data-toggle="lightbox" data-gallery="gallery" data-remote="https://cdn.pixabay.com/photo/2023/05/05/04/38/ai-generated-7971480_640.png">
                                                <img height="300" style="object-fit: cover;" src="https://cdn.pixabay.com/photo/2023/05/05/04/38/ai-generated-7971480_640.png" class="d-block w-100" alt="...">
                                            </div>
