        <div class="nav-header  " style="z-index: 999">
            <a href="{{route('front.home')}}" class="brand-logo py-5 ">
				<img src="{{asset('uploads/site_photos/0ea83f18e14ebe3951eeb034aed66a4b.png')}}" class="w-50 " alt="">
										...
										<div class="dropdown-menu dropdown-menu-end" style="">
											<div class="card border-0 mb-0">
												...
												<div class="card-footer px-0 py-2">
													@if(Auth::user())
														<a href="{{ route('customer_logout') }}" class="dropdown-item ai-icon">
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
		<div class="deznav py-5">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					<li>
						<a  href="{{route('customer_dashboard')}}" aria-expanded="false">
							<div class="menu-icon">
					...
					<li>
						<a  href="{{ route('customer_offers') }}" aria-expanded="false">
							<div class="menu-icon">
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<g opacity="0.5">
					...
					<li>
						<a  href="{{ route('customer_land_transport') }}" aria-expanded="false">
							<div class="menu-icon">
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<g opacity="0.5">
										<path opacity="0.4" d="M10.0833 15.9579H3.50777C2.67555 15.9579 2 16.6217 2 17.4393C2 18.2558 2.67555 18.9206 3.50777 18.9206H10.0833C10.9155 18.9206 11.5911 18.2558 11.5911 17.4393C11.5911 16.6217 10.9155 15.9579 10.0833 15.9579Z" fill="white"/>
							...
							<span class="nav-text">Order for shipping </span>
						</a>
					</li>
					<li>
						<a  href="{{ route('customer_car_and_shipping_information') }}" aria-expanded="false">
							<div class="menu-icon">
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<g opacity="0.5">
										<path opacity="0.4" d="M10.0833 15.9579H3.50777C2.67555 15.9579 2 16.6217 2 17.4393C2 18.2558 2.67555 18.9206 3.50777 18.9206H10.0833C10.9155 18.9206 11.5911 18.2558 11.5911 17.4393C11.5911 16.6217 10.9155 15.9579 10.0833 15.9579Z" fill="white"/>
							...
							<span class="nav-text">Car & Shipping Info </span>
						</a>
					</li>
					<li>
						<a href="{{ route('web_ordering_history') }}" class="" aria-expanded="false">
							<div class="menu-icon">
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<span class="nav-text">Web order History </span>
						</a>
					</li>
					<li>
						<a href="{{ route('customer_shipping_documents') }}" class="" aria-expanded="false">
							<div class="menu-icon">
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<span class="nav-text">Shipping Document</span>
						</a>
					</li>
					<li>
						<a  href="{{ route('customer_invoices') }}" aria-expanded="false">
							<div class="menu-icon">
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<g opacity="0.5">
					...
					<li>
						@if(Auth::user())
							<a href="{{ route('customer_logout') }}" class="" aria-expanded="false">
								<div class="menu-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
										<path d="M9.293 16.293L10.707 17.707L16 12.414V15H18V9H16V11.586L10.707 6.293L9.293 7.707L12.586 11H2V13H12.586L9.293 16.293ZM20 2H4C2.346 2 1 3.346 1 5V19C1 20.654 2.346 22 4 22H20C21.654 22 23 20.654 23 19V5C23 3.346 21.654 2 20 2ZM20 19H4V5H20V19Z" width="24" height="24" fill="white"/>
									</svg>
								</div>
