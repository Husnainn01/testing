                    ...
                    <div class="box w-100 shadow border-1 border-danger mt-3">
                        ...
                        <div class="box-body p-4">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="add_new-tab" data-bs-toggle="tab" data-bs-target="#add_new" type="button" role="tab" aria-controls="add_new" aria-selected="false">Add New</button>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="default" role="tabpanel" aria-labelledby="default-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-12 p-4">
                                            ...
                                            <input type="text" disabled class="form-control" name="default_name" placeholder="Name" value="{{ Auth::user()->name }}">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="consignee_company_name">Company Name<span class="text-danger">*</span></label>
                                            <input type="text" disabled  class="form-control" name="default_company_name" placeholder="Company Name" value="{{ Auth::user()->company_name }}">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="consignee_email">Email<span class="text-danger">*</span></label>
                                            <input type="email" disabled class="form-control" name="default_email" placeholder="email" value="{{ Auth::user()->email }}">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="phone_number">Phone Number<span class="text-danger">*</span></label>
                                            <input type="number" required class="form-control" name="default_phone_number" placeholder="Phone Number" value="{{ Auth::user()->phone }}">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="phone_number_2">Phone Number 2</label>
                                            <input type="number" required class="form-control" name="default_phone_2" placeholder="Phone number" value="{{ Auth::user()->phone }}">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="address">Address <span class="text-danger">*</span></label>
                                            <input type="text" required class="form-control" name="default_address" placeholder="address" value="{{ Auth::user()->address }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="add_new" role="tabpanel" aria-labelledby="add_new-tab">
                                    <div class="row">
                                        <div class="col-12 p-4">
                                            <input type="number" hidden name="consignee_id" value="{{ Auth::user()->id }}">
                                            <label for="consignee_name">Name <span class="text-danger">*</span></label>
                                            <input type="text" required class="form-control" name="consignee_name" placeholder="Name">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="consignee_company_name">Company Name<span class="text-danger">*</span></label>
                                            <input type="text" required class="form-control" name="consignee_company_name" placeholder="Company Name">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="consignee_email">Email<span class="text-danger">*</span></label>
                                            <input type="email" required class="form-control" name="consignee_email" placeholder="email">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="phone_number">Phone Number<span class="text-danger">*</span></label>
                                            <input type="number" required class="form-control" name="phone_number" placeholder="Phone Number">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="phone_number_2">Phone Number 2</label>
                                            <input type="number" required class="form-control" name="phone_number_2" placeholder="Phone number">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="address">Address <span class="text-danger">*</span></label>
                    ...
                    <div class="box w-100 shadow border-1 border-danger mt-3">
                        ...
                        <div class="box-body p-4">
                            <ul class="nav nav-tabs" id="myTab_receiver" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="receiver_default-tab" data-bs-toggle="tab" data-bs-target="#receiver_default" type="button" role="tab" aria-controls="default" aria-selected="true">Default</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="receiver_add_new-tab" data-bs-toggle="tab" data-bs-target="#receiver_add_new" type="button" role="tab" aria-controls="add_new" aria-selected="false">Add New</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTab_receiverContent">
                                <div class="tab-pane fade show active" id="receiver_default" role="tabpanel" aria-labelledby="receiver_default-tab">
                                    <div class="row">
                                        <div class="col-12 p-4">
                                            <input type="text" hidden name="receiver_id" value="{{ Auth::user()->id }}">
                                            <label for="receiver_default_name">Name <span class="text-danger">*</span></label>
                                            <input type="text" required class="form-control" name="receiver_default_name" placeholder="Name" value="{{ Auth::user()->name }}">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_default_company_name">Company Name<span class="text-danger">*</span></label>
                                            <input type="text" required class="form-control" name="receiver_default_company_name" placeholder="Company Name" value="{{ Auth::user()->company_name }}">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_default_email">Email<span class="text-danger">*</span></label>
                                            <input type="email" required class="form-control" name="receiver_default_email" placeholder="email" value="{{ Auth::user()->email }}" >
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_default_phone_number">Phone Number<span class="text-danger">*</span></label>
                                            <input type="number" required class="form-control" name="receiver_default_phone_number" placeholder="Phone Number" value="{{ Auth::user()->phone }}">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_default_phone_number_2">Phone Number 2</label>
                                            <input type="number" required class="form-control" name="receiver_default_phone_2" placeholder="Phone number" value="{{ Auth::user()->phone }}">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_default_address">Address <span class="text-danger">*</span></label>
                                            <input type="text" required class="form-control" name="receiver_default_address" placeholder="address" value="{{ Auth::user()->address }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="receiver_add_new" role="receiver_tabpanel" aria-labelledby="receiver_add_new-tab">
                                    <div class="row">
                                        <div class="col-12 p-4">
                                            <input type="text" hidden name="receiver_id" value="{{ Auth::user()->id }}">
                                            <label for="receiver_add_name">Name <span class="text-danger">*</span></label>
                                            <input type="text" required class="form-control" name="receiver_add_name" placeholder="Name">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_add_company_name">Company Name<span class="text-danger">*</span></label>
                                            <input type="text" required class="form-control" name="receiver_add_company_name" placeholder="Company Name">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_add_email">Email<span class="text-danger">*</span></label>
                                            <input type="email" required class="form-control" name="receiver_add_email" placeholder="email">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_add_phone_number">Phone Number<span class="text-danger">*</span></label>
                                            <input type="number" required class="form-control" name="receiver_add_phone_number" placeholder="Phone Number">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_add_phone_number_2">Phone Number 2</label>
                                            <input type="number" required class="form-control" name="receiver_add_phone_number_2" placeholder="Phone number">
                                        </div>
                                        <div class="col-12 p-4">
                                            <label for="receiver_add_address">Address <span class="text-danger">*</span></label>
                                            <input type="text" required class="form-control" name="receiver_add_address" placeholder="address">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    document.getElementById('submitForm').addEventListener('click', function () {
        ...
        const formData = {
            ...
            receiver_tab: document.querySelector('#myTab_receiver .nav-link.active').id, // Get the active tab id
        };
        let isValid = true;
        ...
        if (formData.consignee_tab === 'default-tab') {
            ...
            formData.default_company_name = document.querySelector('#default input[name="default_company_name"]').value;
            formData.default_email = document.querySelector('#default input[name="default_email"]').value;
            formData.default_phone_number = document.querySelector('#default input[name="default_phone_number"]').value;
            ...
            formData.default_company_name = document.querySelector('#add_new input[name="consignee_company_name"]').value;
        ...
        if (formData.receiver_tab === 'receiver_default-tab') { // Use 'receiver_default' instead of 'receiver_default-tab'
            ...
            formData.receiver_default_name = document.querySelector('#receiver_default input[name="receiver_default_name"]').value;
            formData.receiver_default_company_name = document.querySelector('#receiver_default input[name="receiver_default_company_name"]').value;
            formData.receiver_default_email = document.querySelector('#receiver_default input[name="receiver_default_email"]').value;
            formData.receiver_default_phone_number = document.querySelector('#receiver_default input[name="receiver_default_phone_number"]').value;
            formData.receiver_default_phone_2 = document.querySelector('#receiver_default input[name="receiver_default_phone_2"]').value;
            formData.receiver_default_address = document.querySelector('#receiver_default input[name="receiver_default_address"]').value;
        } else {
            formData.receiver_id = parseInt({{ Auth::user()->id }});
            formData.receiver_default_name = document.querySelector('#receiver_add_new input[name="receiver_add_name"]').value;
            formData.receiver_default_company_name = document.querySelector('#receiver_add_new input[name="receiver_add_company_name"]').value;
            formData.receiver_default_email = document.querySelector('#receiver_add_new input[name="receiver_add_email"]').value;
            formData.receiver_default_phone_number = document.querySelector('#receiver_add_new input[name="receiver_add_phone_number"]').value;
            formData.receiver_default_phone_2 = document.querySelector('#receiver_add_new input[name="receiver_add_phone_number_2"]').value;
            formData.receiver_default_address = document.querySelector('#receiver_add_new input[name="receiver_add_address"]').value;
        }
