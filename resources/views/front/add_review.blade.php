    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="py-5 text-center">
                        ...
                        <div class="form">
                            ...
                            <form action="{{ route('submit-review') }}" method="post" enctype="multipart/form-data"
                                class="w-75 mob-full-width d-block m-auto px-5 py-4 shadow myform rounded">
                                @csrf
                                <!-- Image File Input -->
                                <div class="form-group">
                                    <label for="imageInput">Image</label>
                                    <input name="img" type="file" class="form-control-file" id="imageInput">
                                </div>

                                <!-- Description Input -->
                                <div class="form-group">
                                    <label for="descriptionInput">Description</label>
                                    <textarea name="description" class="form-control" id="descriptionInput" rows="4" placeholder="Enter your review"></textarea>
                                </div>
                ...
                <div class="col-md-6 col-sm-12 col-lg-6 " style="background:#FBFBFB;">
                    <div class="py-5 text-center">
                        <img src="https://assets.materialup.com/uploads/444427ae-92ba-4052-bb60-f144a3fc0c90/animated_teaser.gif"
                            class="w-50 my-3" alt="logo">
                        <h4 class="font-weight-bold">Why SS Japan?</h4>
                        <p class="w-50 d-block m-auto">More than Decade in Business, Exported over 500,000 vehicles to
                            more than 152 countries</p>
