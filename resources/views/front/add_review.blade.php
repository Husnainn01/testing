        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="form">
                            ...
                            <!-- Image URL Input -->
                                <div class="form-group">
                                    ...
                                    <input name="img" type="file" class="w-100" id="imageInput"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="w-100" id="descriptionInput" rows="4"
                ...
                <div class="col-md-6 col-sm-12 col-lg-6 " style="background:#FBFBFB;">
                    <div class="py-5 text-center">
                        <img
                            src="https://assets.materialup.com/uploads/444427ae-92ba-4052-bb60-f144a3fc0c90/animated_teaser.gif"
