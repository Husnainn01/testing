<div class="p-3 text-white nav-small-txt" style="background: #222222;">
    <div class="row">
        <div class="col-lg-3 col-sm-6 col-md-6 col-6"><img
                src="{{ asset('uploads/site_photos/0ea83f18e14ebe3951eeb034aed66a4b.png') }}" height="70"
                alt="">
        ...
        <div class="col-lg-3 col-sm-6 col-md-6 col-6">
            ...
            <ul class="list-unstyled ">
                <li class="my-1"><a href="{{ route('customer_dashboard') }}" class="text-white">Issue Invoice &
                        Reserve </a></li>
            </ul>
            <h6 class="text-primary mt-4">RESERVED</h6>
            <ul class="list-unstyled ">
                <li class="py-1 "><a class="text-white" href="{{ route('all_reserved_vehicles') }}">All Reserved
                        Vehicles / Items</a></li>
                <li class="py-1 "><a class="text-white" href="{{ route('customer_land_transport') }}">Create Order</a>
                </li>
                <li class="py-1 "><a class="text-white" href="{{ route('customer_invoices') }}">Download Invoice</a>
                </li>
                <li class="py-1 "><a class="text-white"
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-6">
            ...
            <ul class="list-unstyled p-2 mb-0">
                ...
                <li class="py-1"><a class="text-white" href="{{ route('list_request_car') }}">List of Requested
                        Cars</a></li>
                ...
                <li class="py-1"><a class="text-white" href="{{ route('update_customer_password') }}">Update your
                        password</a></li>
    ...
    <div class="row bg-dark">
        <div class="col-12 ">
            <ul class="list-unstyled list-inline text-center mt-2">
                <a href='https://www.ss-japan.com/terms_and_services'>
                    <li class="list-inline-item text-white">Terms & Conditions</li>
                </a>

                <a href='https://www.ss-japan.com/privacy_policy'>
                    <li class="list-inline-item text-white">Privacy</li>
                </a>
                <a href='https://www.ss-japan.com/csr_policy'>
                    <li class="list-inline-item text-white">CSR-Policy</li>
                </a>
