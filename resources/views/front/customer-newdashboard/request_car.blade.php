                ...
                <form action="{{ route('requested_car_store') }}" method="POST" class="border p-5">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <input type="text" required class="form-control rounded-3" id="car-name" name="car_name"
                                required>
                        </div>

                        <div class="col-lg-6 col-md-6 col-12">
                            <label for="car-model" class="form-label">Car Model *</label>
                            <input type="text" required class="form-control rounded-3" id="car-model" name="car_model"
                                required>
                        </div>

                        <div class="col-lg-6 col-md-6 col-12 mt-1">
                            <label for="year" class="form-label">Year *</label>
                            <input type="text" required required class="form-control rounded-3" id="year"
                                name="year" required>
                        </div>

                        <div class="col-lg-6 col-md-6 col-12 mt-1">
                            <label for="mileage" class="form-label">Mileage</label>
                            <input type="text" required class="form-control rounded-3" id="mileage" name="mileage"
                                required>
                        </div>

                        <div class="col-lg-6 col-md-6 col-12 mt-1">
                            <label for="engine" class="form-label">Engine *</label>
                            <input type="text" required class="form-control rounded-3" id="engine" name="engine"
                                required>
                        </div>

                        <div class="col-lg-6 col-md-6 col-12 mt-1">
                            <label for="transmission" class="form-label">Transmission *</label>
                            <input type="text" required class="form-control rounded-3" id="transmission"
