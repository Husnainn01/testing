...
<li class="mt-3"><a class="text-decoration-none" href="{{route('category',['slug'=>$item->category_slug])}}"><small><img src="{{asset('uploads/*/'.$item->category_image)}}"/> {{ $item->category_name }}</small></li>
@endforeach
{{-- <li class="mt-3"><a class="text-decoration-none"><small>C</small></li> --}}
 </ul>
