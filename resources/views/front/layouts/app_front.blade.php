...
<html lang="en">
   	...
   	<body>
        ...
        <div id="success" class="myalert alert alert-success hide justify-content-start w-50 text-dark fw-bold shadow" role="alert" style="z-index: 999;
        position: absolute!important;
        left: 424px!important;
        right: 100px!important;
        top: 10px!important;
        z-index:1002;">
           <i  class="fa-solid fa-circle-exclamation" style="color:white;margin-right: 10px;"></i><span id="success-message"></span> {{ session('success') }}
        </div>
        ...
        top: 10px!important;
        z-index:1002;">
           <i  class="fa-solid fa-circle-exclamation" style="color:green;margin-right: 10px;"></i><span id="success-message"></span> {{ session('success') }}
        </div>
      @endif
