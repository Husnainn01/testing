@php
    ...
    $modelYears = \App\Models\Listing::distinct()->orderBy('listing_model_year', 'asc')->pluck('listing_model_year');
@endphp
<header class="desktop-header primary">
    <div class="container-fluid text-light">
        <div class="row border-bottom border-white py-2"
            style="background-color:#414141;color:white;height:35px;border-color: #414141 !important;">
        ...
        <div class="row pt-3" style="background-color:black;">
            <div class="col-md-2 position-relative "
                style="justify-content: center;display: flex;margin-top: -8px !important;">
                <div class="w-60  text-center position-relative">
                    <a href="{{ url('/') }}"><img class="w-75 p-1"
                            src="{{ asset('uploads/site_photos/' . $g_settings->logo) }}" alt="logo"></a>
                </div>
            </div>
            <div class="col-md-6">
                                                        ...
                                                        @foreach ($brands as $branditem)
                                                            @php
                                                                $count = DB::table('listings')
                                                                    ->where('listing_brand_id', $branditem->id)
                                                                    ->count();
                                                            @endphp
            ...
            <div class="col-md-4">
                <div class="d-flex my-auto" style="justify-content: end;font-size: 21px">
                    ...
                    <div class="mr-3">
                        <div class="d-flex">
                            <div class="mr-2">
                                <i class="fa-solid fa-heart fs-4 my-2" style="font-size: 1.1rem"
                                    aria-hidden="true"></i>
                            </div>
                            <div class="my-auto">
                                @auth
                    ...
                    <div class="">
                        @if (Auth::user() || Auth::guard('admin')->check())
                            <div class="mr-3" style="margin-top: 10px">
                                <a href="{{ route('customer_dashboard') }}" class="w-75 m-auto d-block "><small
                                        style="color: white">Dashboard</small></a>
                            </div>
                        @else
                            <div class="dropdown  login-dropdown">
                                <div class="border-0 bg-transparent text-light" style="cursor: pointer;"
                                    type="button" id="dropdownMenuButton" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    <div class="d-flex">
                                        <div class="mr-2"><i class="fas fa-user fs-4 my-2"
                        ...
                        <li class="list-inline-item">
                            <div class="dropdown">
                                <div class="border-0 bg-transparent text-light" style="cursor: pointer;"
                                    ...
                                    aria-haspopup="true" aria-expanded="false">
                                    <div class="d-flex">
                                        <div class="mr-2"><i class="fas fa-headset fs-4 my-2"
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                    ...
                                    <div class="container row">
                                        ...
                                        <div class="dropdown-item" style="max-width: 45% !important;">
                                            <h6>Chat Now</h6>
                                            <small>Chat with SS Japan team &amp;<br> support team for quick <br>answers
                                                on
                                                product features<br> pricing and more</small>
                                            <a href="{{ route('contact') }}"
                                                class="btn btn-primary w-54 my-2 cursor-pointer d-block">Chat
                                                Now</a>
                                            <small class="d-block">24x7</small>
                                            <small><i class="fab fa-whatsapp bg-success p-1 rounded-circle text-light"
                                                    aria-hidden="true"></i> +81-52-387-9772</small>
                        ...
                        <li class="list-inline-item">
                            <div class="dropdown ">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{ route('global_offices') }}">Global Offices</a>
                                    <a class="dropdown-item"
                                        href="{{ route('csr_policycsr_policy') }}">CSR-Policy</a>
                                    <a class="dropdown-item" href="{{ route('terms_services') }}">Terms of
                                        service</a>
                                    <a class="dropdown-item" href="{{ route('privacy_policy') }}">Privacy Policy</a>
                                    <a class="dropdown-item" href="{{ route('cookiecookie') }}">Cookie Policy</a>
                                    <a class="dropdown-item" href="{{ route('security_control') }}">Security Export
            ...
            <div class="col-4" style="height: inherit;">
                <div class="float-right p-  ">
                    <a href="{{ route('front.home') }}"><img
                            src="{{ asset('uploads/site_photos/0ea83f18e14ebe3951eeb034aed66a4b.png') }}"
                            width="40" class="mt-2" alt=""></a>
                </div>
            </div>
        ...
        <div class="main-navigation">
            <ul>
                ...
                <li>
                    ...
                    <div id="help" class="d-block w-100 text-light">Need Help <i
                            class="fas fa-caret-down rotate"></i>
                    </div>
