...
<header class="desktop-header primary" >
    <div class="container-fluid text-light">
        <div class="row border-bottom border-white py-2" style="background-color:gray;color:white;" >
            <div class="col-md-4 ">
                <p class="mb-0">{{ SS_JAPAN_LIMITED_PATNERS_TO_SUCCESS }} </p>
            </div>
            <div class="col-md-4">
               <p class="text-center mb-0"><i class="far fa-clock"></i> Japanese Time : {{ \Carbon\Carbon::now()->format('M/d/Y h:i A') }}</p>
            </div>
            <div class="col-md-4">
                    <div class="dropdown float-right">
                        <form action="{{ route('front_currency') }}" method="POST">
                            ...
                            <div class="dropdown-toggle" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{ session()->get('currency_name', 'USD') }}
                            </div>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                @foreach($currency_list as $row)
                                    <button class="dropdown-item" type="submit" name="currency_name" value="{{ $row->name }}">{{ $row->name }}</button>
                                @endforeach
                            </div>
                        </form>
                    </div>
        ...
        <div class="row pt-3">
            <div class="col-md-2 position-relative ">
                ...
                <a href="{{ url('/') }}"><img class="w-75 p-1" src="{{ asset('uploads/site_photos/' .$g_settings->logo)}}"  alt="logo"></a>
                </div>
                </div>
                    <div class="col-md-6">
    					<form action="{{ url('search-listing') }}" method="POST">
                            @csrf
                            <input class="w-80 py-2 px-3 border-0 search" type="text" placeholder="Search by stock ID or Keyword" name="text">
                            <button type="submit" style="background:#ececed;" class="p-2 border-0 float-right text-dark search-btn">Search</button>
                    ...
                    <li class="list-inline-item">
                        <div class="dropdown stock-dropdown">
                            <button class="bg-transparent text-light dropdown-toggle border-0" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Search From Stock
                            </button>
                                ...
                                <div class="col-md-3 border-right">
                                    ...
                                    @php $count = DB::table('listings')->where('listing_brand_id', $branditem->id)->count(); @endphp
                                       <li class="nav-item px-1">
                                        <a href="{{route('brandsfilter',['slug'=>$branditem->listing_brand_slug])}}" class="nav-link"><small><img  width="20" src="{{asset('uploads/listing_brand_photos/'.$branditem->listing_brand_photo)}}" />{{$branditem->listing_brand_name}}({{$count}})</small></a>
                                    </li>
                                       @endforeach
                                ...
                                <div class="col-md-2 border-right">
                                    ...
                                    <ul class="list-unstyled mob-hide">
                                        <a href="{{route('pricing',['price1'=>'0','price2'=>'500'])}}" class="text-dark" style="text-decoration:none;">
                                            <li class="py-2">
                                                <i class="fas fa-tag theme-text theme-text " aria-hidden="true"></i>
                                                <small>$0 - $500</small>
                                            </li>
                                        </a>
                                        ...
                                        <a href="{{route('pricing',['price1'=>'3000','price2'=>'90000'])}}" class="text-dark" style="text-decoration:none;">
                                            <li class="py-2">
                                                <i class="fas fa-tag theme-text " aria-hidden="true"></i>
                            ...
                            <div class="col-md-2 border-right">
                                    ...
                                    <ul class="list-unstyled brand-list">
                                        ...
                                        @if($item)
                                        <li><a href="{{route('find_model_year',['year'=>$item])}}" class="w-100"><small class="w-100 d-block py-1">{{$item}}</small></a></li>
                                        @endif
                                        @endforeach
                                    </ul>
                                </div>
                                <div class="col-md-3 border-right">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li class=""><small class="d-block"><a class="text-decoration-none d-block w-100 py-2" href="{{route('location_find',['slug'=>$locationitem->listing_location_slug])}}"><img class="mr-2 mx-2" src="{{asset('uploads/listing_location_photos/'.$locationitem->listing_location_photo)}}" height="20" width="30">{{$locationitem->listing_location_name}}</a></small></li>
                                        @endforeach
                                ...
                                <div class="col-md-2">
                                    ...
                                    <ul class="list-unstyled mob-hide">
             <li class=" py-2 ">                           <a href="{{route('steering',['type'=>'right_steering'])}}" class="d-block px-2" style="text-decoration:none;"><i class="fas fa-car theme-text" aria-hidden="true"></i><small> Right Hand</small></a></li>
                                  <li class=" py-2 ">      <a href="{{route('steering',['type'=>'left_steering'])}}" class="d-block px-2" style="text-decoration:none;"><i class="fas fa-car theme-text" aria-hidden="true"></i><small> Left Hand</small></a></li>
                   ...
                   <li class="list-inline-item"><div class="dropdown ">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="{{route('basic_policy')}}">Bais Policy Against Anti-Social Forces </a>
                        <a href="{{route('how-we-deliver')}}" class=" text-decoration-none dropdown-item" aria-label="Menu Item">{{ HOW_WE_DELIVER}}</a>


                    </div>
                </div></li>
                <li  class="list-inline-item ">
                    <a href="{{route('liveoption')}}" class="text-light text-decoration-none" aria-label="Menu Item">{{ LIVE_AUCTION }}</a>
                  </li>
        ...
        <div class="d-flex my-auto justify-content-end">
            <div class="mr-3">
                <div class="dropdown float-right support-dropdown">
                    <div class="border-0 bg-transparent text-light" style="cursor: pointer;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="d-flex">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <small><i class="fab fa-whatsapp bg-success p-1 rounded-circle text-light" aria-hidden="true"></i> +81-52-387-9772</small>
                                </div>
            ...
            <div class="mr-3">
                ...
                <div class="d-flex">
                    ...
                    <div class="my-auto">
                        <a class="text-light" href="{{route('customer_dashboard')}}">
                            <small class="m-0 text-light">Check favourite</small>
                        </a>
                    </div>
            ...
            <div class="">
                <div class="dropdown  login-dropdown">
                    <div class="border-0 bg-transparent text-light" style="cursor: pointer;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="d-flex">
                            <div class="mr-2"><i class="fas fa-user-circle fs-4 my-2" aria-hidden="true"></i></div>
                                <div class=" my-auto pl-0" onclick="{{ route('customer_login') }}">
                                    <small class="m-0">Sign In To</small>
                        ...
                        <div class="container">
                            @if(Auth::user() || (Auth::guard('admin')->check()))
                                    @if(Auth::guard('admin')->check())
                                        <div class="row">
                                            <small class="d-block w-100 text-center font-weight-bold">My Account</small>
                                            <a href="{{ route('admin_dashboard') }}" class="w-75 m-auto d-block "><button class="w-100 d-block mt-2 btn-primary"  style="border-radius:5px!important;cursor:pointer;">Dashboard</button></a>
                                            <a href="{{ route('admin_logout') }}" class="w-75 m-auto d-block "><button class="w-100 d-block mt-2 btn-primary"  style="border-radius:5px!important;cursor:pointer;">Logout</button></a>
                                        </div>
                                    @else
                                        <div class="row">
                                            <small class="d-block w-100 text-center font-weight-bold">My Account</small>
                                            <a href="{{ route('customer_dashboard') }}" class="w-75 m-auto d-block "><button class="w-100 d-block mt-2 btn-primary"  style="border-radius:5px!important;cursor:pointer;">Dashboard</button></a>
                                            <a href="{{ route('customer_logout') }}" class="w-75 m-auto d-block "><button class="w-100 d-block mt-2 btn-primary"  style="border-radius:5px!important;cursor:pointer;">Logout</button></a>
                                        </div>
                                    @endif
                                @else
                                <div class="row">
                                    <small class="d-block text-center w-100 font-weight-bold">My
                                        Account</small>
                                    <a href="{{ route('customer_login') }}" class="w-75 m-auto d-block"><button class="w-100 d-block m-auto btn-primary my-5" style="border-radius:5px!important;cursor:pointer;">Sign
                                            In</button></a>
                                    <br><br>
...
<header class="site-header-block">
    ...
    <div class="mobile-header">
        ...
        <div class="col-3" style="height: inherit;"> <div class="mobile-nav-toggle">
            <span>
                <i></i>
                <i></i>
                <i></i>
          ...
          <div class="col-4" style="height: inherit;">
            <div class="float-right p-  ">
                <a href="{{route('front.home')}}"><img  src="{{asset('uploads/site_photos/0ea83f18e14ebe3951eeb034aed66a4b.png')}}" width="40" class="mt-2" alt=""></a>
            </div>
          </div>
    ...
    <div class="navigation">
      ...
      <div class="main-navigation">
        <ul>
          <li>
            <div class="dropdown">
                <div class="text-light " type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <li>
            ...
            <div id="help" class="d-block w-100 text-light">Need Help <i class="fas fa-caret-down rotate"></i></div>
          ...
          <li class="text-light">
           ...
           <div id="aboutss" class="d-block w-100">About SS Japan <i class="fas fa-caret-down rotate"></i></div>
