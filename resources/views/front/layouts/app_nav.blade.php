                ...
                <div class="dropdown float-right">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        @foreach($location as $row)
                            <a class="dropdown-item" href="{{ route('location_find', ['slug' => $row->listing_location_slug]) }}">
                                <img src="{{asset('uploads/listing_location_photos/'.$row->listing_location_photo)}}" class="small-logo" alt="">
        ...
        <div class="d-flex my-auto justify-content-end">
            ...
            <div class="mr-3">
                ...
                <div class="d-flex">
                    ...
                    <div class="my-auto">
                        <a class=" text-light"><small class="m-0 text-light" href="#">Check</small>
                            <small class="m-0 text-light">favourite</small>
                        </a>
                    </div>
